  ...
  plans: [
    ...
    },
    {
      ...
      features: [
        ...
        { text: "Все текстовые ИИ-модели", included: true, bold: false },
        { text: "Генерация изображений", included: true, bold: false },
        { text: "4–200 страниц текста", included: true, bold: false },
        { text: "5–40 изображений", included: true, bold: false },
        { text: "30+ готовых ассистентов", included: true, bold: false },
    ...
    },
    {
      ...
      features: [
        ...
        { text: "Все текстовые ИИ-модели", included: true, bold: false },
        { text: "Генерация изображений", included: true, bold: false },
        { text: "11–480 страниц текста", included: true, bold: false },
        { text: "15–125 изображений", included: true, bold: false },
        { text: "1–15 видео", included: true, bold: false },
        { text: "30+ готовых ассистентов", included: true, bold: false },
    ...
    },
    {
      ...
      features: [
        ...
        { text: "Все текстовые ИИ-модели", included: true, bold: false },
        { text: "Генерация изображений", included: true, bold: false },
        { text: "30–1 700 страниц текста", included: true, bold: false },
        { text: "25–400 изображений", included: true, bold: false },
        { text: "2–45 видео", included: true, bold: false },
        { text: "30+ готовых ассистентов", included: true, bold: false },
        { text: "Видеогенерация", included: true, bold: true },
        { text: "Создание своих ассистентов", included: true, bold: true },
